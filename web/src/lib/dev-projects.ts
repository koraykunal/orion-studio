...
export function getDevProjects(locale: string): Project[] {
    return [
                ...
                },
                {
                    ...
                    data: {
                        ...
                        images: [
                            ...
                            { src: "/og-image.png", alt: "Orion visual direction frame" },
                            { src: "/images/services/identity.svg", alt: "Identity system study" },
                            { src: "/images/services/web.svg", alt: "Web interface study" },
                        ],
                    },
                },
                {
                ...
                },
                {
                    ...
                    data: {
                        devices: [
                            ...
                            { type: "laptop", image: "/og-image.png", alt: "Laptop approval workflow" },
                            { type: "phone", image: "/images/services/apps.svg", alt: "Mobile status view" },
                        ],
                    },
                },
                {
        ...
        },
        {
            ...
            image: "/images/services/production.svg",
            previewVideo: "",
            category: "concept",
