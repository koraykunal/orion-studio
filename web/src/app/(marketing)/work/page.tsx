...
const projects: Project[] = [
    {
        ...
        tagline: "Redefining urban transit for the electric age",
        year: "2025",
        services: ["Brand Strategy", "Web Engineering", "Motion Systems"],
        outcome: "Multi-market launch site with CMS-backed case stories and real-time fleet data integration. 3.2s avg load time, 180% increase in investor inquiries.",
        image: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=1400&h=900&fit=crop&q=80",
        featured: true,
    },
    {
        slug: "atlar-finance",
        client: "Atlar Finance",
        tagline: "Trust, visualized",
        year: "2025",
        services: ["Visual Identity", "Product Design", "Frontend Engineering"],
        outcome: "Modular landing kit with analytics-ready events, interactive data visualizations, and multi-language support for EU compliance.",
    ...
    },
    {
        slug: "museo-light",
        client: "Museo Light",
        tagline: "Where art meets immersion",
        year: "2024",
        services: ["Experience Strategy", "Web Design", "CMS Integration"],
        outcome: "Rich media exhibition platform with ticketing integrations, virtual walkthroughs, and artist portfolio system.",
        image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1400&h=900&fit=crop&q=80",
        featured: true,
    },
    {
        slug: "helix-health",
        ...
        year: "2024",
        services: ["Product Design", "Design Systems", "Analytics & Growth"],
        outcome: "HIPAA-compliant patient portal with real-time appointment scheduling, telehealth integration, and accessibility-first design.",
        image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1400&h=900&fit=crop&q=80",
    },
    {
        slug: "terranova-outdoor",
        client: "Terranova Outdoor",
        tagline: "Adventure, curated",
        year: "2024",
        services: ["Brand Strategy", "E-Commerce", "Visual Identity"],
        outcome: "Headless Shopify storefront with dynamic product configurator, expedition booking system, and community-driven content hub.",
        image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1400&h=900&fit=crop&q=80",
    },
    {
        slug: "sine-audio",
        client: "Sine Audio",
        ...
        year: "2023",
        services: ["Web Design", "Motion Systems", "Frontend Engineering"],
        outcome: "WebGL-powered product showcase with spatial audio demos, configurator, and subscription management for premium tiers.",
        image: "https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?w=1400&h=900&fit=crop&q=80",
    },
];
